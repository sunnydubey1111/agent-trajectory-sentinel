...
def test_legacy_arrow_form_corpus_results_are_recovered():
    ...
    Its results sit OUTSIDE the bracket, the form a bracket-only regex misses.
    The corpora themselves were re-collected under the v5 schema, so this
    fixture is what pins the parser against a regression.
    """
