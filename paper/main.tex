...
The embedding is a deterministic char-3-gram feature hash (no model, no network). v4 telemetry costs 608 $\mu$s/step at the adapter; the lexical flag alone costs 2 $\mu$s/result.
