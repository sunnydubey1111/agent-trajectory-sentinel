...
\title{Online Derailment Detection for LLM Agents from Step Telemetry: From Echo-State Ensembles to Grounded Hybrid Monitoring}
...
\textbf{Everything this paper claims about deployment rests on this section.} The committed corpus spans $\sim$1,700 episodes over 17 datasets --- three frameworks, three local agent models across two families, and the gemini-2.5-flash API --- every episode a live agent run against real tools, with telemetry measured at the adapter rather than constructed.
